...
INSERT INTO pets (name, birth_date, type_id, owner_id, weight, pet_length) SELECT 'Leo', '2000-09-07', 1, 1, 6, 20 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=1);
INSERT INTO pets (name, birth_date, type_id, owner_id, weight, pet_length) SELECT 'Basil', '2002-08-06', 6, 2, 6, 20 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=2);
INSERT INTO pets (name, birth_date, type_id, owner_id, weight, pet_length) SELECT 'Rosy', '2001-04-17', 2, 3, 6, 20 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=3);
INSERT INTO pets (name, birth_date, type_id, owner_id, weight, pet_length) SELECT 'Jewel', '2000-03-07', 2, 3, 6, 20 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=4);
INSERT INTO pets (name, birth_date, type_id, owner_id, weight, pet_length) SELECT 'Iggy', '2000-11-30', 3, 4, 6, 20 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=5);
INSERT INTO pets (name, birth_date, type_id, owner_id, weight, pet_length) SELECT 'George', '2000-01-20', 4, 5, 6, 20 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=6);
INSERT INTO pets (name, birth_date, type_id, owner_id, weight, pet_length) SELECT 'Samantha', '1995-09-04', 1, 6, 6, 20 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=7);
INSERT INTO pets (name, birth_date, type_id, owner_id, weight, pet_length) SELECT 'Max', '1995-09-04', 1, 6, 6, 20 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=8);
INSERT INTO pets (name, birth_date, type_id, owner_id, weight, pet_length) SELECT 'Lucky', '1999-08-06', 5, 7, 6, 20 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=9);
INSERT INTO pets (name, birth_date, type_id, owner_id, weight, pet_length) SELECT 'Mulligan', '1997-02-24', 2, 8, 6, 20 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=10);
INSERT INTO pets (name, birth_date, type_id, owner_id, weight, pet_length) SELECT 'Freddy', '2000-03-09', 5, 9, 6, 20 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=11);
INSERT INTO pets (name, birth_date, type_id, owner_id, weight, pet_length) SELECT 'Lucky', '2000-06-24', 2, 10, 6, 20 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=12);
INSERT INTO pets (name, birth_date, type_id, owner_id, weight, pet_length) SELECT 'Sly', '2002-06-08', 1, 10, 6, 20 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=13);
